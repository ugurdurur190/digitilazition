@extends('layouts.menu')
    ...
    <div class="row">
		<div class="col-4">
			<h4 style="color: black;">Devam Eden Proje Giriş Formu</h4>
		</div>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="button" class="btn btn-dark" onclick="this.disabled=true;">
                                                                                <a style="color: white; text-decoration:none;" href="{{ url('forms/continues-project/question/delete',[$question->id]) }}">
                                                                                    Sil
                                                                                </a>
                                                                            </button>
                                                                        </div>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-dark" data-bs-dismiss="modal">Geri</button>
                                                                            <button type="button" class="btn btn-dark" onclick="this.disabled=true;">
                                                                                <a style="color: white; text-decoration:none;" href="{{ url('forms/continues-project/process/delete',[$processes->id]) }}">
                                                                                    Sil
                                                                                </a>
                                                                            </button>
                                                                        </div>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('forms/continues-project/question/store') }}" method="GET" id="question-store">
                                @csrf
            ...
            <div class="modal fade" id="newProcess" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('forms/continues-project/process/store') }}" method="GET" id="process-store">
                                @csrf
                                <input type="hidden" name="form_id" class="form-control form-control-sm" value="{{ $forms->id }}" required>
                                    <div class="container">
                                        <div class="row">
